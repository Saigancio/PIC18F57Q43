...
void sincronizador(void) {
    ...
    uint16_t suma_mes = 0;
    _Bool hora_encontrada = 0;
    _Bool dia_encontrado = 0;
    _Bool num_encontrado = 0;
    _Bool mes_encontrado = 0;
    ...
    for(i = 0; i < indice; i++) {
        ...
        if(tramaserial[i] == 'M' &&
           ...
           tramaserial[i+5] == ':') {
            ...
            suma_mes = tramaserial[i+7]+tramaserial[i+8]+tramaserial[i+9];
            switch(suma_mes) {
                case 0x119: mes = "Enero"; break;
                case 0x10D: mes = "Febrero"; break;
                case 0x120: mes = "Marzo"; break;
                case 0x123: mes = "Abril"; break;
                case 0x127: mes = "Mayo"; break;
                case 0x12D: mes = "Junio"; break;
                case 0x12B: mes = "Julio"; break;
                case 0x11D: mes = "Agosto"; break;
                case 0x128: mes = "Septiembre"; break;
                case 0x126: mes = "Octubre"; break;
                case 0x133: mes = "Noviembre"; break;
                case 0x10C: mes = "Diciembre"; break;
...
void menu_wea(void){
        char temp_str[10];
    float temp = conversor_temperatura();

    sprintf(temp_str, "%.2f", temp);
    char milib_str[10];
    int milib = conversor_milibar();
    sprintf(milib_str, "%d", milib);
    char hum_str[10];
    int hum= conversor_humedad();
...
void menu_ala() {
    ...
    if (horas == alahor && minutos == alamin) {
    ...
    char str_alahor[3], str_alamin[3], str_alaseg[3];
    ...
    SSD1306_I2C_Update(&SSD1306);
    SSD1306_I2C_ClearDisplay(&SSD1306);
    SSD1306_I2C_Cadena(&SSD1306, 30, 10, str_alahor);
    SSD1306_I2C_Caracter(&SSD1306, 50, 10, ':');
    SSD1306_I2C_Cadena(&SSD1306, 60, 10, str_alamin);
    SSD1306_I2C_Caracter(&SSD1306, 80, 10, ':');
    SSD1306_I2C_Cadena(&SSD1306, 90, 10, str_alaseg);

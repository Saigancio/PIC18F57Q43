...
//Creditos a la libreria de Wells (SSD1306) que ha sido modificada, añadiendo la funcion "Animation" y la corrección de bugs.
//Se ha usado códigos del repositorio del Ing. Kalun (tocache)
//Tambien añadir el uso de la IA Claude para la corrección de bugs menores y demás
//Este proyecto se actualizará constantemente usando git con la finalidad de explorar las capacidades del PIC18F57Q43

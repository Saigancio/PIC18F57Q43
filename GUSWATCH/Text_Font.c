...
0x00,0x1F,0x3F,0x61,0x61,0x61,0x61,0x3F,0x1F,0x00,   // Círculo inferior
    
    // 7
0x00,0x03,0x03,0x03,0x03,0xC3,0xF3,0x3F,0x0F,0x00,  // Línea superior y inicio diagonal
0x00,0x00,0x00,0x70,0x7C,0x1F,0x07,0x01,0x00,0x00,   // Continuación diagonal
...
0x00,0x1F,0x3F,0x60,0x63,0x63,0x63,0x63,0x00,0x00,
    // A (0x41) - Diseño angular inspirado en carteles soviéticos
...
// P (0x50) - Semicírculo superior con línea vertical
...
// Y (0x59) - Bifurcación superior con tallo
...
// h (0x68) - Línea vertical con gancho
0x00,0xFF,0xFF,0x80,0x80,0x80,0xC0,0xC0,0x00,0x00,
0x00,0x3F,0x3F,0x01,0x01,0x01,0x3F,0x3E,0x00,0x00,

// i (0x69) - Línea vertical simple con punto
...
// o (0x6F) - Forma ovalada pero más angular que la O mayúscula
...
0x00,0xE0,0xF0,0x90,0x90,0x90,0xF0,0xE0,0x00,0x00,  // Círculo superior
0x00,0xFF,0xFF,0x21,0x21,0x21,0x3F,0x1E,0x00,0x00,  // Línea vertical extendida

// q (0x71) - Como 'p' espejada
0x00,0xE0,0xF0,0x90,0x90,0x90,0xF0,0xE0,0x00,0x00,  // Círculo superior
0x00,0x1E,0x3F,0x21,0x21,0x21,0xFF,0xFF,0x00,0x00,  // Línea vertical extendida
...
// s (0x73) - Versión más pequeña de S mayúscula
...
// t (0x74) - Línea vertical con barra horizontal
0x00,0x40,0x40,0xF8,0xFC,0x40,0x40,0x00,0x00,0x00,  // Barra superior y línea
0x00,0x00,0x00,0x1F,0x3F,0x20,0x20,0x00,0x00,0x00,  // Continuación línea

// u (0x75) - Como 'n' invertida
0x00,0xC0,0xE0,0x00,0x00,0x00,0xE0,0xE0,0x00,0x00,  // Líneas verticales
0x00,0x1F,0x3F,0x20,0x20,0x20,0x3F,0x3F,0x20,0x00,  // Base curva

// v (0x76) - Versión más pequeña de V mayúscula
...
// x (0x78) - Cruces diagonales más compactas
...
// z (0x7A) - Versión compacta de Z mayúscula
0x00,0x20,0x20,0xA0,0xE0,0x60,0x20,0x00,0x00,0x00,  // Línea superior y diagonal

...
extern const uint8_t SOVIET_FONTS[];
# 3 "SSD1306.c" 2
...
static void SSD1306_I2C_SendCommand( ssd1306_t * SSD1306 , uint8_t command )
{
  ...
  SSD1306->cmd[1] = command;
        ...
        I2C1_WRITESINGLEBYTE(SSD1306->address,SSD1306->cmd, 2);
# 23 "SSD1306.c"
}
...
static void SSD1306_I2C_SendData( ssd1306_t * SSD1306 )
{
  SSD1306->data[0] = 0x40;
        ...
        I2C1_WRITESINGLEBYTE(SSD1306->address,SSD1306->data, 17);
# 47 "SSD1306.c"
}
...
void SSD1306_I2C_Init( ssd1306_t * SSD1306 )
{
  ...
  SSD1306_I2C_SendCommand( SSD1306, 0xAE);
  SSD1306_I2C_SendCommand( SSD1306,0xD5);
  SSD1306_I2C_SendCommand( SSD1306,0x80);
  SSD1306_I2C_SendCommand( SSD1306,0xA8 );
  SSD1306_I2C_SendCommand( SSD1306,SSD1306->height - 1 );
  SSD1306_I2C_SendCommand( SSD1306,0xD3 );
  SSD1306_I2C_SendCommand( SSD1306,0x00);
  SSD1306_I2C_SendCommand( SSD1306,0x40|0x00);
  SSD1306_I2C_SendCommand( SSD1306,0x8D );
  SSD1306_I2C_SendCommand( SSD1306,0x14);
  SSD1306_I2C_SendCommand( SSD1306,0x20 );
  SSD1306_I2C_SendCommand( SSD1306,0x00);
  SSD1306_I2C_SendCommand( SSD1306,0xA0| 0x01);
  SSD1306_I2C_SendCommand( SSD1306,0xC8 );
  ...
  SSD1306_I2C_SendCommand( SSD1306,0xDA );
  SSD1306_I2C_SendCommand( SSD1306,0x12 );
  SSD1306_I2C_SendCommand( SSD1306,0x81 );
  SSD1306_I2C_SendCommand( SSD1306,SSD1306->contrast);

  SSD1306_I2C_SendCommand( SSD1306,0xD9 );
  SSD1306_I2C_SendCommand( SSD1306,0xF1 );
  SSD1306_I2C_SendCommand( SSD1306,0xDB );
  SSD1306_I2C_SendCommand( SSD1306,0x40 );
  SSD1306_I2C_SendCommand( SSD1306,0xA4 );
  SSD1306_I2C_SendCommand( SSD1306,0xA6 );
  SSD1306_I2C_SendCommand( SSD1306,0x2E );
  SSD1306_I2C_SendCommand( SSD1306,0xAF );
...
void SSD1306_I2C_Update(ssd1306_t * SSD1306)
{
    ...
    SSD1306_I2C_SendCommand(SSD1306, 0x21);
    SSD1306_I2C_SendCommand(SSD1306, 0);
    SSD1306_I2C_SendCommand(SSD1306, SSD1306->width-1);


    SSD1306_I2C_SendCommand(SSD1306, 0x22);
    SSD1306_I2C_SendCommand(SSD1306, 0);
    SSD1306_I2C_SendCommand(SSD1306, 7);
...
void SSD1306_I2C_InvertDisplay( ssd1306_t * SSD1306, uint8_t value )
{
  if( value )
  {
    SSD1306_I2C_SendCommand( SSD1306, 0xA7 );
  }
  else
  {
    SSD1306_I2C_SendCommand( SSD1306, 0xA6 );
...
uint8_t getRandom(uint8_t limit) {
    seed++;
